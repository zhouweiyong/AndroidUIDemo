...
public class ImageTools {
	 ...
	 * 保存拍照后的图片,用于上传
	 */
	public static File saveImgForUpload(String tempFilePath,Context context) {
...
//		intent.setAction(Intent.ACTION_GET_CONTENT);
	 ...
	 * 取得图片路径
	 */
	public  static File initTempFile(Context context) {
		//File uploadFileDir = new File(VolleyRequestManager.getCacheDir(), "img_temp");
		File uploadFileDir = new File(context.getExternalCacheDir(), "img_temp");
