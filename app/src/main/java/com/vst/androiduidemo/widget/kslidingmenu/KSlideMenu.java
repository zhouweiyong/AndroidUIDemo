 ...
 * 普通侧滑
 */
public class KSlideMenu extends HorizontalScrollView {
    ...
    public KSlideMenu(Context context) {
        this(context, null);
    }

    public KSlideMenu(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public KSlideMenu(Context context, AttributeSet attrs, int defStyleAttr) {
